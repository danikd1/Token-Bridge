...
Задание выполнено на 10 баллов: Создание токена (1 балла) + Разработка моста (2 балла) + Взаимодействие между сетями (2 балла) + Тестирование и деплой (5 баллов)
...
## Задание 4: Тестирование и деплой
